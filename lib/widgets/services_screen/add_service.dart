...
class _AddServiceState extends State<AddService> {
  ...
  void _saveItem() async {
    ...
    try {
      ...
      final doc = await servicesCollection.add({
      ...
      final newItem = ServiceClass(
          serviceImage: imageUrl,
          serviceTitle: _enteredTitle,
          serviceDescription: _enteredDecription,
          servicePrice: _enteredPrice,
          id: doc.id);
      if (!mounted) return;
